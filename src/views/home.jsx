		...
		<main className="home">
			...
			<section className="card-container">
				...
				<div id="our-features" className="card appsus-keep flex column align-center">
					<img className="card-img" src="img/notes_logo.svg" alt=""></img>
					<h3>Appsus keep</h3>
				...
				<div className="card appsus-books flex column align-center">
					<img className="card-img" src="img/books_logo.png" alt=""></img>
